...
import { Brain, Cpu, Sparkles, Terminal, Workflow, Database, Zap } from 'lucide-react';
import { aiExpertise, aiSkills } from '../data/ai-expertise';
        ...
        >
          ...
          >
            <p className="text-muted-foreground">
              ...
              Built with Next.js 16, it features interactive RAG-powered chat
              and AI workflow visualizations.
            </p>
          </motion.div>
        </motion.div>
      </div>
